...
option, see [Configuration](wiki/Configuration.md).

For advanced setup and configuration, such as how to best configure your
webserver, see the [advanced configuration page](wiki/AdvancedConfiguration.md).
# Options
...
editor in the configuration file. See [Configuration](wiki/Configuration.md).
...
[Configuration](wiki/Configuration.md) if you would like to make the default
...
For more information about theming, see [theming](wiki/Theming.md).
